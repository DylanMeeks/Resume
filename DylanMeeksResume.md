...
- Lead two-person team in designing and assembling a prototype circuit board to 
accept power from a solar panel and output clean Pulse Width Modulated power to 
external electric motor
- Interfaced with DACs, ADCs, PWM generator, and Ti TM4C microcontroller

**Local Area Networked Battleship Game (April 2022)**
- Worked with a team of 10 to develop a text user interface Battleship with LAN 
multiplayer
- Project was designed from scratch and written in java with custom communication 
protocol

**Wirelessly Controlled Sumo Wrestling Robot (March 2021)**
- Lead design and fabrication of wirelessly controlled robot to take first in a 
competition to push or flip an opponent robot out of a ring
